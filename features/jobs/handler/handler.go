...
func (handler *JobHandler) CreateJobs(c echo.Context) error {
	...
	// result, err := handler.jobService.GetCompanyID(CompanyId)
	// if err != nil {
	...
	// responURL := handler.jobService.Photo(inputPhoto)
...
// read product by id
// func (handler *JobHandler) GetSingleJob(c echo.Context) error {
// 	productID := c.Param("job_id")

// 	jobID, errConv := strconv.Atoi(productID)
// 	if errConv != nil {
// 		return c.JSON(http.StatusBadRequest, responses.WebResponse(http.StatusBadRequest, "error convert id param", nil))
// 	}

// 	result, errFirst := handler.jobService.GetSingleJob(jobID)
// 	if errFirst != nil {
...
// read product by id
// func (handler *JobHandler) GetStoreProduct(c echo.Context) error {
// 	userID := middlewares.ExtractTokenUserId(c)
// 	storeID, err := handler.jobService.GetStoreID(userID)
// 	if err != nil {
// 		return c.JSON(http.StatusInternalServerError, responses.WebResponse(http.StatusInternalServerError, "error read data, "+err.Error(), nil))
// 	}

// 	result, errFirst := handler.jobService.GetStoreProducts(storeID)
// 	if errFirst != nil {
// 		return c.JSON(http.StatusInternalServerError, responses.WebResponse(http.StatusInternalServerError, "error read data. "+errFirst.Error(), nil))
// 	}
